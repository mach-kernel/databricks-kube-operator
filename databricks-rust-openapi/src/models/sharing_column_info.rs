...
pub struct SharingColumnInfo {
    ...
    pub type_name: Option<crate::models::SharingColumnTypeName>,
    ...
    pub mask: Option<Box<crate::models::SharingColumnMask>>,
}

impl SharingColumnInfo {
    pub fn new() -> SharingColumnInfo {
        SharingColumnInfo {
            type_text: None,
            type_json: None,

...
pub struct WorkspaceWorkspaceObjectAccessControlResponse {
    #[serde(rename = "all_permissions", skip_serializing_if = "Option::is_none")]
    pub all_permissions: Option<Vec<crate::models::WorkspaceWorkspaceObjectPermission>>,
...
impl WorkspaceWorkspaceObjectAccessControlResponse {
    pub fn new() -> WorkspaceWorkspaceObjectAccessControlResponse {
        WorkspaceWorkspaceObjectAccessControlResponse {

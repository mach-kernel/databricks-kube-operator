...
pub struct ComputeEditInstancePool {
    ...
    #[serde(rename = "instance_pool_name")]
...
impl ComputeEditInstancePool {
    pub fn new(instance_pool_name: String, instance_pool_id: String, node_type_id: String) -> ComputeEditInstancePool {

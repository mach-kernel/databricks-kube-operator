...
/// CatalogColumnTypeName : Name of type (INT, STRUCT, MAP, etc.).

/// Name of type (INT, STRUCT, MAP, etc.).
#[derive(JsonSchema, Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum CatalogColumnTypeName {
...
impl ToString for CatalogColumnTypeName {
...
impl Default for CatalogColumnTypeName {
    fn default() -> CatalogColumnTypeName {
        Self::Boolean
    }
}

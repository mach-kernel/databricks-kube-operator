...
pub struct ServingEndpointCoreConfigOutput {
...
impl ServingEndpointCoreConfigOutput {
    pub fn new() -> ServingEndpointCoreConfigOutput {
        ServingEndpointCoreConfigOutput {
            config_version: None,
            served_models: None,
            traffic_config: None,
        }

...
pub struct ServingServingEndpointAccessControlResponse {
    #[serde(rename = "all_permissions", skip_serializing_if = "Option::is_none")]
    pub all_permissions: Option<Vec<crate::models::ServingServingEndpointPermission>>,
...
impl ServingServingEndpointAccessControlResponse {
    pub fn new() -> ServingServingEndpointAccessControlResponse {

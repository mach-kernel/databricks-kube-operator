...
pub struct MlRejectTransitionRequest {
...
impl MlRejectTransitionRequest {
    pub fn new(name: String, stage: crate::models::Mlstage, version: String) -> MlRejectTransitionRequest {

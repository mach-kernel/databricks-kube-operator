...
pub struct WorkspaceWorkspaceObjectAccessControlRequest {
    /// name of the group
...
impl WorkspaceWorkspaceObjectAccessControlRequest {
    pub fn new() -> WorkspaceWorkspaceObjectAccessControlRequest {

...
pub struct IamObjectPermissions {
    #[serde(rename = "access_control_list", skip_serializing_if = "Option::is_none")]
    pub access_control_list: Option<Vec<crate::models::IamAccessControlResponse>>,
    /// 
...
impl IamObjectPermissions {
    pub fn new() -> IamObjectPermissions {

...
pub struct ComputeClusterPolicyAccessControlResponse {
    #[serde(rename = "all_permissions", skip_serializing_if = "Option::is_none")]
    pub all_permissions: Option<Vec<crate::models::ComputeClusterPolicyPermission>>,
...
impl ComputeClusterPolicyAccessControlResponse {
    pub fn new() -> ComputeClusterPolicyAccessControlResponse {

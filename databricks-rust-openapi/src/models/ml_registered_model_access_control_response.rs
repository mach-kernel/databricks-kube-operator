...
pub struct MlRegisteredModelAccessControlResponse {
    #[serde(rename = "all_permissions", skip_serializing_if = "Option::is_none")]
    pub all_permissions: Option<Vec<crate::models::MlRegisteredModelPermission>>,
...
impl MlRegisteredModelAccessControlResponse {
    pub fn new() -> MlRegisteredModelAccessControlResponse {

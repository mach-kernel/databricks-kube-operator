...
pub struct WorkspaceCreateScope {
    ...
    pub backend_azure_keyvault: Option<Box<crate::models::WorkspaceAzureKeyVaultSecretScopeMetadata>>,
    ...
    pub scope_backend_type: Option<crate::models::WorkspaceScopeBackendType>,
}

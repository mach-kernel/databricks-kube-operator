...
pub struct ServingServingEndpointAccessControlRequest {
    /// name of the group
...
impl ServingServingEndpointAccessControlRequest {
    pub fn new() -> ServingServingEndpointAccessControlRequest {
        ServingServingEndpointAccessControlRequest {
            group_name: None,

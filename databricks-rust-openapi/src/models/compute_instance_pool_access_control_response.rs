...
pub struct ComputeInstancePoolAccessControlResponse {
    #[serde(rename = "all_permissions", skip_serializing_if = "Option::is_none")]
    pub all_permissions: Option<Vec<crate::models::ComputeInstancePoolPermission>>,
...
impl ComputeInstancePoolAccessControlResponse {
    pub fn new() -> ComputeInstancePoolAccessControlResponse {

...
pub struct SqlWarehouseAccessControlResponse {
    #[serde(rename = "all_permissions", skip_serializing_if = "Option::is_none")]
    pub all_permissions: Option<Vec<crate::models::SqlWarehousePermission>>,
...
impl SqlWarehouseAccessControlResponse {
    pub fn new() -> SqlWarehouseAccessControlResponse {

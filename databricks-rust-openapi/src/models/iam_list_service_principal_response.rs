...
pub struct IamListServicePrincipalResponse {
    #[serde(rename = "Resources", skip_serializing_if = "Option::is_none")]
    pub resources: Option<Vec<crate::models::IamServicePrincipal>>,
...
impl IamListServicePrincipalResponse {
    pub fn new() -> IamListServicePrincipalResponse {

...
pub struct PipelinesEditPipeline {
    ...
    #[serde(rename = "expected_last_modified", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "allow_duplicate_names", skip_serializing_if = "Option::is_none")]
...
impl PipelinesEditPipeline {
    pub fn new() -> PipelinesEditPipeline {

...
pub struct ComputeAwsAttributes {
    ...
    pub ebs_volume_type: Option<crate::models::ComputeEbsVolumeType>,
...
impl ComputeAwsAttributes {
    pub fn new() -> ComputeAwsAttributes {

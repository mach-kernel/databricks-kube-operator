...
pub struct ComputeClusterAccessControlResponse {
    #[serde(rename = "all_permissions", skip_serializing_if = "Option::is_none")]
    pub all_permissions: Option<Vec<crate::models::ComputeClusterPermission>>,
...
impl ComputeClusterAccessControlResponse {
    pub fn new() -> ComputeClusterAccessControlResponse {

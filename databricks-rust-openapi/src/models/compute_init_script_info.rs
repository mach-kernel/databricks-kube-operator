...
pub struct ComputeInitScriptInfo {
    ...
    /// destination needs to be provided. Eg. `{ \"workspace\" : { \"destination\" : \"/Users/user1@databricks.com/my-init.sh\" } }`
    #[serde(rename = "workspace", skip_serializing_if = "Option::is_none")]
    pub workspace: Option<Box<crate::models::ComputeWorkspaceStorageInfo>>,
}

impl ComputeInitScriptInfo {
    pub fn new() -> ComputeInitScriptInfo {

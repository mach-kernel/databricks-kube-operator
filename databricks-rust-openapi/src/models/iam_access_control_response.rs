...
pub struct IamAccessControlResponse {
    #[serde(rename = "all_permissions", skip_serializing_if = "Option::is_none")]
    pub all_permissions: Option<Vec<crate::models::IamPermission>>,
...
impl IamAccessControlResponse {
    pub fn new() -> IamAccessControlResponse {

...
pub struct SettingsTokenAccessControlResponse {
    #[serde(rename = "all_permissions", skip_serializing_if = "Option::is_none")]
    pub all_permissions: Option<Vec<crate::models::SettingsTokenPermission>>,
...
impl SettingsTokenAccessControlResponse {
    pub fn new() -> SettingsTokenAccessControlResponse {

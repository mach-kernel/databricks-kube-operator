...
pub struct CatalogListTablesResponse {
    ...
    pub tables: Option<Vec<crate::models::CatalogTableInfo>>,
}

impl CatalogListTablesResponse {
    pub fn new() -> CatalogListTablesResponse {
        CatalogListTablesResponse {

...
pub struct WorkspaceRepoAccessControlResponse {
    #[serde(rename = "all_permissions", skip_serializing_if = "Option::is_none")]
    pub all_permissions: Option<Vec<crate::models::WorkspaceRepoPermission>>,
...
impl WorkspaceRepoAccessControlResponse {
    pub fn new() -> WorkspaceRepoAccessControlResponse {

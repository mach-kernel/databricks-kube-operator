...
pub struct JobsJobPermissions {
    #[serde(rename = "access_control_list", skip_serializing_if = "Option::is_none")]
    pub access_control_list: Option<Vec<crate::models::JobsJobAccessControlResponse>>,
    /// 
...
impl JobsJobPermissions {
    pub fn new() -> JobsJobPermissions {
        JobsJobPermissions {

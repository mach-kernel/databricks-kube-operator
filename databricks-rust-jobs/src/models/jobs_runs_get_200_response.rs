...
pub struct JobsRunsGet200Response {
    ...
    #[serde(rename = "git_source", default, skip_serializing_if = "Option::is_none")]
...
impl JobsRunsGet200Response {
    pub fn new() -> JobsRunsGet200Response {

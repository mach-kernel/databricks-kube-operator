...
/// NewTaskCluster : If new_cluster, a description of a cluster that is created only for this task.



#[derive(JsonSchema, Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct NewTaskCluster {
...
impl NewTaskCluster {
    ...
    pub fn new(spark_version: String) -> NewTaskCluster {
        NewTaskCluster {
            num_workers: None,
            autoscale: None,
            spark_version,

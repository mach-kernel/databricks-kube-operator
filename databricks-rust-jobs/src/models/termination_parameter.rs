...
pub struct TerminationParameter {
    ...
    #[serde(
        rename = "aws_instance_state_reason",
    ...
    #[serde(
        rename = "aws_spot_request_status",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "aws_spot_request_fault_code",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "aws_impaired_status_details",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "aws_instance_status_event",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "instance_pool_error_code",
        skip_serializing_if = "Option::is_none"
    )]

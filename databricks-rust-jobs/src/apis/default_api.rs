...
/// Create a new job.
pub async fn jobs_create(configuration: &configuration::Configuration, jobs_create_request: Option<crate::models::JobsCreateRequest>) -> Result<crate::models::JobsCreate200Response, Error<JobsCreateError>> {
...
/// Deletes a job.
pub async fn jobs_delete(configuration: &configuration::Configuration, jobs_delete_request: Option<crate::models::JobsDeleteRequest>) -> Result<serde_json::Value, Error<JobsDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_get(configuration: &configuration::Configuration, job_id: Option<i64>) -> Result<crate::models::JobsGet200Response, Error<JobsGetError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_list(configuration: &configuration::Configuration, limit: Option<i32>, offset: Option<i32>, expand_tasks: Option<bool>) -> Result<crate::models::JobsList200Response, Error<JobsListError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_reset(configuration: &configuration::Configuration, jobs_reset_request: Option<crate::models::JobsResetRequest>) -> Result<serde_json::Value, Error<JobsResetError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_run_now(configuration: &configuration::Configuration, jobs_run_now_request: Option<crate::models::JobsRunNowRequest>) -> Result<crate::models::JobsRunNow200Response, Error<JobsRunNowError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_runs_cancel(configuration: &configuration::Configuration, jobs_runs_cancel_request: Option<crate::models::JobsRunsCancelRequest>) -> Result<serde_json::Value, Error<JobsRunsCancelError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_runs_cancel_all(configuration: &configuration::Configuration, jobs_runs_cancel_all_request: Option<crate::models::JobsRunsCancelAllRequest>) -> Result<serde_json::Value, Error<JobsRunsCancelAllError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_runs_delete(configuration: &configuration::Configuration, jobs_runs_delete_request: Option<crate::models::JobsRunsDeleteRequest>) -> Result<serde_json::Value, Error<JobsRunsDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_runs_export(configuration: &configuration::Configuration, run_id: Option<i64>, views_to_export: Option<ViewsToExport>) -> Result<crate::models::JobsRunsExport200Response, Error<JobsRunsExportError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_runs_get(configuration: &configuration::Configuration, run_id: Option<i64>, include_history: Option<bool>) -> Result<crate::models::JobsRunsGet200Response, Error<JobsRunsGetError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_runs_get_output(configuration: &configuration::Configuration, run_id: Option<i64>) -> Result<crate::models::JobsRunsGetOutput200Response, Error<JobsRunsGetOutputError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_runs_repair(configuration: &configuration::Configuration, jobs_runs_repair_request: Option<crate::models::JobsRunsRepairRequest>) -> Result<crate::models::JobsRunsRepair200Response, Error<JobsRunsRepairError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_runs_submit(configuration: &configuration::Configuration, jobs_runs_submit_request: Option<crate::models::JobsRunsSubmitRequest>) -> Result<crate::models::JobsRunsSubmit200Response, Error<JobsRunsSubmitError>> {
    let local_var_configuration = configuration;
...
pub async fn jobs_update(configuration: &configuration::Configuration, jobs_update_request: Option<crate::models::JobsUpdateRequest>) -> Result<serde_json::Value, Error<JobsUpdateError>> {
    let local_var_configuration = configuration;
